...
const BalanceBeam: React.FC<BalanceBeamProps> = ({ onBack }) => {
    ...
    const [chatHistory, setChatHistory] = useState<ChatMessage[]>([
        { text: "Welcome to The Balance Beam! ⚖️", sender: 'bot' },
        { text: "Drag the blue weights. Watch how the Fulcrum (Mean) moves to balance them, while the Median stays put.", sender: 'bot' }
    ]);
            ...
            <main className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 h-[600px]">
                    <AITutor 
                        ...
                        className="h-full"
                        suggestedActions={[
                            { label: "Why did Mean move?", action: () => handleSendMessage("Why did the mean move but median didn't?") },
                            { label: "What is an outlier?", action: () => handleSendMessage("What is an outlier?") },
                        ]}
                    />
                </div>
            </main>
